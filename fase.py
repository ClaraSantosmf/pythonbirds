...
class Fase():
    def __init__(self, intervalo_de_colisao=1):
        ...
        self._passaros = [] #atributo com _ indica que não se deve acessar esse atributo diretamente. Ou seja, não realize interação direta.
        self._porcos = []
        self._obstaculos = []
    ...
    def adicionar_obstaculo(self, *obstaculos):
        ...
        :param obstaculos:
        """
        self._obstaculos.extend(obstaculos)  #extend é comando de adicionar objeto.
    ...
    def calcular_pontos(self, tempo):
        ...
        for passaro in self._passaros: #para cada passaro na lista de passaros
            passaro.calcular_posicao(tempo) #chama a função de calcular posição recebendo o tempo como parâmetro.
