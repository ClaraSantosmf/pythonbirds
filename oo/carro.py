...
class Direcao:
    rotacao_a_direita_dct = {NORTE: LESTE, LESTE: SUL, SUL: OESTE, OESTE: NORTE} #ao invés de if e else, posso substituir por dicionário
...
class Carro:
    def __init__(self, direcao, motor): #será composta por direção e motor
        self.motor = motor
